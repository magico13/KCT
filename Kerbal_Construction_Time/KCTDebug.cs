    ...
    public class KCT_OnLoadError
    {
        ...
        public void FireAlert()
        {
            if (!AlertFired)
            {
                ...
                PopupDialog.SpawnPopupDialog("Error Loading KCT Data", "ERROR! An error while loading KCT data occurred. Things will be seriously broken! Please report this error to the KCT forum post with the log file.", "Understood", false, HighLogic.Skin);
            }
        }
    }
}
