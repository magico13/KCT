...
namespace Kerbal_Construction_Time
{
    public class KCT_TechItem : IKCTBuildItem
    {
        ...
        public double BuildRate { get { return (KCT_GameStates.timeSettings.NodeModifier * Math.Pow(2, KCT_GameStates.TechUpgradesTotal + 1) / 86400.0); } } //0pts=1day/2sci, 1pt=1/4, 2=1/8, 3=1/16, 4=1/32...n=1/2^(n+1)
